 ...
 */
class Version20180422214931 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE user (id BIGINT AUTO_INCREMENT NOT NULL, first_name CHAR(100) NOT NULL, last_name CHAR(100) NOT NULL, email CHAR(100) NOT NULL, phone CHAR(100) NOT NULL, password CHAR(100) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
    }
